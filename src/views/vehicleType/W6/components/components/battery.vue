  ...
  <div class="batteryPage">
    ...
    >
      <swiper-slide
        ...
        data-background="https://cos-data.wm-imotor.com/website/W6/pc/w6/battery-1.jpg"
      ></swiper-slide>
      <swiper-slide
        class="slideItem slideItem1-2 swiper-lazy"
        data-background="https://cos-data.wm-imotor.com/website/W6/pc/w6/battery-2.jpg"
      ></swiper-slide>
      <swiper-slide
        class="slideItem slideItem1-3 swiper-lazy"
        data-background="https://cos-data.wm-imotor.com/website/W6/pc/w6/battery-3.jpg"
      ></swiper-slide>
...
let _that;
const btnHtml = [
  "<div class='btn'><p class='btn-tit'>模块化电池包</p><p class='btn-cons'>累计多达120,000次充放电测试</br>电池衰减仅5%</p></div>",
  "<div class='btn'><p class='btn-tit'>多效电池安全保障</p><p class='btn-cons'>远超国标的66项高标准检测;防水防尘达到了最高级的IP68级;电池管理系统(BMS)实时监控、确保电池正常安全运行</p></div>",
