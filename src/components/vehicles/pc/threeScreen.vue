<template>
  ...
  >
    <p
      v-if="data.text1"
      class="threeScreenPage-tit threeScreenPage-text threeScreenChange1"
    >
      {{ data.text1 }}
    </p>
    <p
      ...
      <div class="dianBox">
        ...
        <div
          ...
          :style="{
            ...
            top: dian2.top + 'px',
            right: dian2.right + 'px'
          }"
        ></div>
        <div
          class="three-xt three-3 threeScreenChange2"
          :style="{
            width: '349px',
            height: '107px',
            backgroundImage: 'url(' + data.bg3 + ')',
            top: dian3.top + 'px',
            left: dian3.left + 'px'
          }"
        ></div>
...
export default {
  ...
  methods: {
    setDianTLFn() {
      ...
      console.log('bl', bl)
      this.dian1.left = this.dian1Bf.left * bl - 28 - 430;
      this.dian1.top = this.dian1Bf.top * bl - 119;
      this.dian2.right = this.dian2Bf.right * bl - 28 - 439;
      this.dian2.top = this.dian2Bf.top * bl;
